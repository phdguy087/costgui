                    ...
                    if q:
                        with col2:
                            ...
                            with tab1:
                                ...
                                fig1 = px.scatter(df1, x="cost", y="Reduction", color='Area',color_continuous_scale=px.colors.sequential.Viridis)
                                fig2 =px.scatter(df2, x="cost", y="Reduction", color='Area',color_continuous_scale=px.colors.sequential.Viridis)
                                fig3 = go.Figure(data=fig1.data + fig2.data)
                                fig3.add_hline(y=removal,name= 'Reduction level',line=dict(color='firebrick', width=2,
                                                      dash='dash'))
                                fig3.add_hrect(y0=removal-con_level, y1=removal + con_level, line_width=0, fillcolor="red", opacity=0.2)
                    ...
                    if q:
                        with col2:
                            ...
                            with tab1:
                                ...
                                fig2 = px.scatter(df1, x="cost", y="Reduction", color='Area',color_continuous_scale=px.colors.sequential.Viridis)
                                fig2.px.scatter(df2, x="cost", y="Reduction", color='Area',color_continuous_scale=px.colors.sequential.Viridis)
                                fig2.add_hline(y=removal,name= 'Reduction level',line=dict(color='firebrick', width=2,
                                                      dash='dash'))
                                fig2.add_hrect(y0=removal-con_level, y1=removal + con_level, line_width=0, fillcolor="red", opacity=0.2)
                    ...
                    with col2:
                        ...
                        with tab1:
                          ...
                          xaxis=dict(
                            ...
                            with tab2: 
                                st.dataframe(df)
        elif SCM_type=='Porous Pavement, Vegetative Filterbed & Wet Pond':
