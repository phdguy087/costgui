            ...
            if q:
                with col2:
                    ...
                    with tab1:
                        ...
                        fig.add_trace(go.Scatter(x=df["cost (USD)"],y=df["Nitrogen Reduction (lb/yr)"],mode='markers',name='Nitrogene Reduction',marker=dict(color='rgba(8,88,158, 0.6)')),row = 1, col = 1)
