        ...
        if SCM_type=='Bioretention & Vegetative Filterbed':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3,tab4,tab5,tab6 = st.tabs(["graph_N","Graph_P","Table_N","Table_P","Cost_N","Cost_P"])
                    def simple_1d_fitness_func_tp(p1,p2,p3,p4):
                        objective_1 = 29631*(p1*p2)**0.026 + 687.5*(p1*p2)**0.59 
                        objective_2 = ((98-(117.1*(2.718)**(-5.21*(p2))))*((584.706*(p2)**0.012)-560.448))/100
                        
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    def simple_1d_fitness_func_tn(p1,p2,p3,p4):
                        objective_1 = 29631*(p1*p2)**0.026 + 687.5*(p1*p2)**0.59 
                        objective_2 = ((98-(117.1*(2.718)**(-5.21*(p2))))*((29.031*(p2)**0.17)+ 8.47))/100
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    config = {
                                "half_pop_size" : 50,
                                "problem_dim" : 2,
        ...
        if SCM_type=='Bioretention & Wet Pond':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3,tab4,tab5,tab6 = st.tabs(["graph_N","Graph_P","Table_N","Table_P","Cost_N","Cost_P"])
                    def simple_1d_fitness_func_tn(p1,p2,p3,p4):
                        objective_1 = 29631*(p1*p2)**0.026 + 1875*(p1*p2)**0.503
                        objective_2 = ((98-(117.1*(2.718)**(-5.21*(p2))))*((4389.78*(p2)**0.012)-4286.26))/100
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    def simple_1d_fitness_func_tp(p1,p2,p3,p4):
                        objective_1 = 687.5*(p1*p2)**0.59 
                        objective_2 = ((98-(117.1*(2.718)**(-5.21*(p2))))*((260.665*(p2)**0.0285)-223.36))/100
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    config = {
                                "half_pop_size" : 50,
                                "problem_dim" : 2,
        ...
        if SCM_type=='Porous Pavement & Dry Pond':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3 = st.tabs(["graph","table","Cost"])
                    def simple_1d_fitness_func(p1,p2,p3,p4):
                        objective_1 = 40540*(p1*p2)**0.0327  + 10525*(p1*p2)**0.29 
                        objective_2 = ((97.9016-(105.3*(2.718)**(-5.51*(p2))))*(98.26-(109.04*(2.718)**(-5.75*(p2)))))/100
        ...
        if SCM_type=='Porous Pavement & Grassed Swale':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3 = st.tabs(["graph","table","Cost"])
                    def simple_1d_fitness_func(p1,p2,p3,p4):
                        objective_1 = 40540*(p1*p2)**0.0327  + 42504*(p1*p2)**0.0344    
                        objective_2 = ((97.9016-(105.3*(2.718)**(-5.51*(p2))))*(97.7936-(107.28*(2.718)**(-5.85*(p2)))))/100
        ...
        if SCM_type=='Porous Pavement & Infiltration Trench':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3 = st.tabs(["graph","table","Cost"])
                    def simple_1d_fitness_func(p1,p2,p3,p4):
                        objective_1 = 40540*(p1*p2)**0.0327  + 27632*(p1*p2)**0.0431    
                        objective_2 = ((97.9016-(105.3*(2.718)**(-5.51*(p2))))*((63767.5*(p2)**0.000285)-63679.2))/100
        ...
        if SCM_type=='Porous Pavement & Constructed Wetland':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3,tab4,tab5,tab6 = st.tabs(["graph_N","Graph_P","Table_N","Table_P","Cost_N","Cost_P"])
                    def simple_1d_fitness_func_tn(p1,p2,p3,p4):
                        objective_1 = 40540*(p1*p2)**0.0327  + 1875*(p1*p2)**0.503 
                        objective_2 = ((97.9016-(105.3*(2.718)**(-5.51*(p2))))*((4389.78*(p2)**0.012)-4286.26))/100
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    
                    def simple_1d_fitness_func_tp(p1,p2,p3,p4):
                        objective_1 = 40540*(p1*p2)**0.0327  + 1875*(p1*p2)**0.503
                        objective_2 = ((97.9016-(105.3*(2.718)**(-5.51*(p2))))*((260.665*(p2)**0.0285)-223.36))/100
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
        ...
        if SCM_type=='Porous Pavement & Vegetative Filterbed':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3,tab4,tab5,tab6 = st.tabs(["graph_N","Graph_P","Table_N","Table_P","Cost_N","Cost_P"])
                    def simple_1d_fitness_func_tp(p1,p2,p3,p4):
                        objective_1 = 40540*(p1*p2)**0.0327  + 687.5*(p1*p2)**0.59 
                        objective_2 = ((97.9016-(105.3*(2.718)**(-5.51*(p2))))*((584.706*(p2)**0.012)-560.448))/100
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    def simple_1d_fitness_func_tn(p1,p2,p3,p4):
                        objective_1 = 40540*(p1*p2)**0.0327  + 687.5*(p1*p2)**0.59 
                        objective_2 = ((97.9016-(105.3*(2.718)**(-5.51*(p2))))*((29.031*(p2)**0.17)+ 8.47))/100
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    config = {
                                "half_pop_size" : 50,
                                "problem_dim" : 2,
        ...
        if SCM_type=='Infiltration Trench & Dry Pond':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3 = st.tabs(["graph","table","Cost"])
                    def simple_1d_fitness_func(p1,p2,p3,p4):
                        objective_1 = 27632*(p1*p2)**0.0431  + 10525*(p1*p2)**0.29  
                        objective_2 = (((63767.5*(p2)**0.000285)-63679.2)*(98.26-(109.04*(2.718)**(-5.75*(p2)))))/100
        ...
        if SCM_type=='Infiltration Trench & Grassed Swale':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3 = st.tabs(["graph","table","Cost"])
                    def simple_1d_fitness_func(p1,p2,p3,p4):
                        objective_1 = 27632*(p1*p2)**0.0431  + 42504*(p1*p2)**0.0344   
                        objective_2 = (((63767.5*(p2)**0.000285)-63679.2)*(97.7936-(107.28*(2.718)**(-5.85*(p2)))))/100
        ...
        if SCM_type=='Infiltration Trench & Constructed Wetland':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3,tab4,tab5,tab6 = st.tabs(["graph_N","Graph_P","Table_N","Table_P","Cost_N","Cost_P"])
                    def simple_1d_fitness_func_tn(p1,p2,p3,p4):
                        objective_1 = 27632*(p1*p2)**0.0431  + 1875*(p1*p2)**0.503  
                        objective_2 = (((63767.5*(p2)**0.000285)-63679.2)*((4389.78*(p2)**0.012)-4286.26))/100
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    def simple_1d_fitness_func_tp(p1,p2,p3,p4):
                        objective_1 = 27632*(p1*p2)**0.0431  + 1875*(p1*p2)**0.503  
                        objective_2 = (((63767.5*(p2)**0.000285)-63679.2)*((260.665*(p2)**0.0285)-223.36))/100
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    config = {
                                "half_pop_size" : 50,
                                "problem_dim" : 2,
        ...
        if SCM_type=='Infiltration Trench & Vegetative Filterbed':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3,tab4,tab5,tab6 = st.tabs(["graph_N","Graph_P","Table_N","Table_P","Cost_N","Cost_P"])
                    def simple_1d_fitness_func_tp(p1,p2,p3,p4):
                        objective_1 = 27632*(p1*p2,p3,p4)**0.0431  + 687.5*(p1*p2)**0.59 
                        objective_2 = (((63767.5*(p2)**0.000285)-63679.2)*((584.706*(p2)**0.012)-560.448))/100
                        
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    def simple_1d_fitness_func_tn(p1,p2):
                        objective_1 = 27632*(p1*p2)**0.0431  + 687.5*(p1*p2)**0.59 
                        objective_2 = (((63767.5*(p2)**0.000285)-63679.2)*((29.031*(p2)**0.17)+ 8.47))/100
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    config = {
                                "half_pop_size" : 50,
                                "problem_dim" : 2,
        ...
        if SCM_type=='Grassed Swale & Dry Pond':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3 = st.tabs(["graph","table","Cost"])
                    def simple_1d_fitness_func(p1,p2,p3,p4):
                        objective_1 = 42504*(p1*p2)**0.0344   + 10525*(p1*p2)**0.29 
                        objective_2 = ((97.7936-(107.28*(2.718)**(-5.85*(p2))))*(98.26-(109.04*(2.718)**(-5.75*(p2)))))/100
        ...
        if SCM_type=='Grassed Swale & Constructed Wetland':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3,tab4,tab5,tab6 = st.tabs(["graph_N","Graph_P","Table_N","Table_P","Cost_N","Cost_P"])
                    def simple_1d_fitness_func_tn(p1,p2,p3,p4):
                        objective_1 = 42504*(p1*p2)**0.0344   + 1875*(p1*p2)**0.503  
                        objective_2 = ((97.7936-(107.28*(2.718)**(-5.85*(p2))))*((4389.78*(p2)**0.012)-4286.26))/100
                         
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    def simple_1d_fitness_func_tp(p1,p2,p3,p4):
                        objective_1 = 42504*(p1*p2)**0.0344   + 1875*(p1*p2)**0.503   
                        objective_2 = ((97.7936-(107.28*(2.718)**(-5.85*(p2))))*((260.665*(p2)**0.0285)-223.36))/100
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    config = {
                                "half_pop_size" : 50,
                                "problem_dim" : 2,
        ...
        if SCM_type=='Grassed Swale & Vegetative Filterbed':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3,tab4,tab5,tab6 = st.tabs(["graph_N","Graph_P","Table_N","Table_P","Cost_N","Cost_P"])
                    def simple_1d_fitness_func_tp(p1,p2,p3,p4):
                        objective_1 = 42504*(p1*p2)**0.0344  + 687.5*(p1*p2)**0.59 
                        objective_2 = ((97.7936-(107.28*(2.718)**(-5.85*(p2))))*((584.706*(p2)**0.012)-560.448))/100
                        
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    def simple_1d_fitness_func_tn(p1,p2):
                        objective_1 = 42504*(p1*p2)**0.0344  + 687.5*(p1*p2)**0.59 
                        objective_2 = ((97.7936-(107.28*(2.718)**(-5.85*(p2))))*((29.031*(p2)**0.17)+ 8.47))/100
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    config = {
                                "half_pop_size" : 50,
                                "problem_dim" : 2,
        ...
        if SCM_type=='Wet Pond & Vegetative Filterbed':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3,tab4,tab5,tab6 = st.tabs(["graph_N","Graph_P","Table_N","Table_P","Cost_N","Cost_P"])
                    def simple_1d_fitness_func_tn(p1,p2,p3,p4):
                        objective_1 = 687.5*(p1*p2)**0.59 + 1875*(p1*p2)**0.503  
                        objective_2 = (((29.031*(p2)**0.17)+ 8.47)*((4389.78*(p2)**0.012)-4286.26))/100
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    def simple_1d_fitness_func_tp(p1,p2,p3,p4):
                        objective_1 = 687.5*(p1*p2)**0.59 + 1875*(p1*p2)**0.503  
                        objective_2 = (((584.706*(p2)**0.012)-560.448)*((260.665*(p2)**0.0285)-223.36))/100
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    config = {
                                "half_pop_size" : 50,
                                "problem_dim" : 2,
        ...
        if SCM_type=='Dry Pond & Vegetative Filterbed':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3,tab4,tab5,tab6 = st.tabs(["graph_N","Graph_P","Table_N","Table_P","Cost_N","Cost_P"])
                    def simple_1d_fitness_func_tp(p1,p2,p3,p4):
                        objective_1 = 10525*(p1*p2)**0.29 + 687.5*(p1*p2)**0.59 
                        objective_2 = ((98.26-(109.04*(2.718)**(-5.75*(p2))))*((584.706*(p2)**0.012)-560.448))/100
                        return np.stack([p1,p2,p3,p4,objective_1,objective_2],axis=1)
                    def simple_1d_fitness_func_tn(p1,p2,p3,p4):
                        objective_1 = 10525*(p1*p2)**0.29 + 687.5*(p1*p2)**0.59   
                        objective_2 = ((98.26-(109.04*(2.718)**(-5.75*(p2))))*((29.031*(p2)**0.17)+ 8.47))/100
            ...
            if q:
                with col2:
                    ...
                    def simple_1d_fitness_func_tp(p1,p2,p3,p4,p5,p6):
                        objective_1 = 29631*(p1*p2)**0.026 +40540*(p1*p2)**0.0327+ 1875*(p1*p2)**0.503 
                        objective_2 = ((98-(117.1*(2.718)**(-5.21*(p2))))*(97.9016-(105.3*(2.718)**(-5.51*(p2))))*((4389.78*(p2)**0.012)-4286.26))/10000
                        return np.stack([p1,p2,p3,p4,p5,p6,objective_1,objective_2],axis=1)
                    def simple_1d_fitness_func_tn(p1,p2,p3,p4,p5,p6):
                        objective_1 = 29631*(p1*p2)**0.026 +40540*(p1*p2)**0.0327+ 1875*(p1*p2)**0.503 
                        objective_2 = ((98-(117.1*(2.718)**(-5.21*(p2))))*(97.9016-(105.3*(2.718)**(-5.51*(p2))))*((260.665*(p2)**0.0285)-223.36))/10000
                        return np.stack([p1,p2,p3,p4,p5,p6,objective_1,objective_2],axis=1)
                    config = {
                                "half_pop_size" : 50,
                                "problem_dim" : 2,
        ...
        if SCM_type=='Bioretention, Grassed Swale & Wet Pond':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3,tab4,tab5,tab6 = st.tabs(["graph_N","Graph_P","Table_N","Table_P","Cost_N","Cost_P"])
                    def simple_1d_fitness_func_tp(p1,p2,p3,p4,p5,p6):
                        objective_1 = 29631*(p1*p2)**0.026 + 42504*(p1*p2)**0.0344 + 1875*(p1*p2)**0.503  
                        objective_2 = ((98-(117.1*(2.718)**(-5.21*(p2))))*(97.7936-(107.28*(2.718)**(-5.85*(p2))))*((4389.78*(p2)**0.012)-4286.26))/10000
                        return np.stack([p1,p2,p3,p4,p5,p6,objective_1,objective_2],axis=1)
                    def simple_1d_fitness_func_tn(p1,p2,p3,p4,p5,p6):
                        objective_1 = 29631*(p1*p2)**0.026 + 42504*(p1*p2)**0.0344 + 1875*(p1*p2)**0.503   
                        objective_2 = ((98-(117.1*(2.718)**(-5.21*(p2))))*(97.7936-(107.28*(2.718)**(-5.85*(p2))))*((260.665*(p2)**0.0285)-223.36))/10000
                        return np.stack([p1,p2,p3,p4,p5,p6,objective_1,objective_2],axis=1)
                    config = {
                                "half_pop_size" : 50,
                                "problem_dim" : 2,
        ...
        if SCM_type=='Bioretention, Vegetative Filterbed & Wet Pond':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3,tab4,tab5,tab6 = st.tabs(["graph_N","Graph_P","Table_N","Table_P","Cost_N","Cost_P"])
                    def simple_1d_fitness_func_tp(p1,p2,p3,p4,p5,p6):
                        objective_1 = 29631*(p1*p2)**0.026 + 29631*(p1*p2)**0.026 +687.5*(p1*p2)**0.59   
                        objective_2 = ((98-(117.1*(2.718)**(-5.21*(p2))))*((29.031*(p2)**0.17)+ 8.47)*((4389.78*(p2)**0.012)-4286.26))/10000
                        return np.stack([p1,p2,p3,p4,p5,p6,objective_1,objective_2],axis=1)
                    def simple_1d_fitness_func_tn(p1,p2,p3,p4,p5,p6):
                        objective_1 = 29631*(p1*p2)**0.026 + 29631*(p1*p2)**0.026 +687.5*(p1*p2)**0.59    
            ...
            if q:
                with col2:
                    ...
                    def simple_1d_fitness_func_tp(p1,p2,p3,p4,p5,p6,p7,p8):
                        objective_1 = 29631*(p1*p2)**0.026 + 40540*(p1*p2)**0.0327 + 687.5*(p1*p2)**0.59 + 1875*(p1*p2)**0.503  
                        objective_2 = ((98-(117.1*(2.718)**(-5.21*(p2))))*(97.9016-(105.3*(2.718)**(-5.51*(p2))))*((29.031*(p2)**0.17)+ 8.47)*((4389.78*(p2)**0.012)-4286.26))/1000000
                    ...
                    def simple_1d_fitness_func_tn(p1,p2,p3,p4,p5,p6,p7,p8):
                        objective_1 = 29631*(p1*p2)**0.026 + 40540*(p1*p2)**0.0327 + 687.5*(p1*p2)**0.59 + 1875*(p1*p2)**0.503   
                        objective_2 = ((98-(117.1*(2.718)**(-5.21*(p2))))*(97.9016-(105.3*(2.718)**(-5.51*(p2))))*((584.706*(p2)**0.012)-560.448)*((260.665*(p2)**0.0285)-223.36))/1000000
                        return np.stack([p1,p2,p3,p4,p5,p6,p7,p8,objective_1,objective_2],axis=1)
                    config = {
                                "half_pop_size" : 50,
                                "problem_dim" : 2,
        ...
        if SCM_type=='Bioretention, Porous Pavement, Grassed Swale & Wet Pond':
            ...
            if q:
                with col2:
                    ...
                    tab1,tab2,tab3,tab4,tab5,tab6 = st.tabs(["graph_N","Graph_P","Table_N","Table_P","Cost_N","Cost_P"])
                    def simple_1d_fitness_func_tp(p1,p2,p3,p4,p5,p6,p7,p8):
                        objective_1 = 29631*(p1*p2)**0.026 + 40540*(p1*p2)**0.0327 + 42504*(p1*p2)**0.0344  + 1875*(p1*p2)**0.503  
                        objective_2 = ((98-(117.1*(2.718)**(-5.21*(p2))))*(97.9016-(105.3*(2.718)**(-5.51*(p2))))*(97.7936-(107.28*(2.718)**(-5.85*(p2))))*((4389.78*(p2)**0.012)-4286.26))/1000000
                        return np.stack([p1,p2,p3,p4,p5,p6,p7,p8,objective_1,objective_2],axis=1)
                    def simple_1d_fitness_func_tn(p1,p2,p3,p4,p5,p6,p7,p8):
                        objective_1 = 29631*(p1*p2)**0.026 + 40540*(p1*p2)**0.0327 + 42504*(p1*p2)**0.0344  + 1875*(p1*p2)**0.503  
                        objective_2 = ((98-(117.1*(2.718)**(-5.21*(p2))))*(97.9016-(105.3*(2.718)**(-5.51*(p2))))*(97.7936-(107.28*(2.718)**(-5.85*(p2))))*((260.665*(p2)**0.0285)-223.36))/1000000
                        return np.stack([p1,p2,p3,p4,p5,p6,p7,p8,objective_1,objective_2],axis=1)
                    config = {
                                "half_pop_size" : 50,
                                "problem_dim" : 2,
