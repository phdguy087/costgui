        ...
        if SCM_type=='Bioretention & Wet Pond':
            ...
            if q:
                with col2:
                    ...
                    fit_C= parameters[2]
                    cost = round(fit_A*removal +fit_B*removal**2 + fit_C,2)                                       
                    df= pd.DataFrame(pp_solutions_fitnesses,columns=["Area of Bioretention","Depth of Bioretention","Percentage1","Area of Wet Pond","Depth of Green Roof","Percentage2","Cost","Reduction"])
                    with tab1:
                        fig1 = px.line(df, x="Cost", y="Reduction")
